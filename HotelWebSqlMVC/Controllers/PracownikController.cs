...
namespace HotelWebSqlMVC.Controllers
{
 ...
 " order by Osoba.O_Imie, Osoba.O_Nazwisko, Rezerwacja.R_NaKiedy, Rezerwacja.R_DoKiedy asc";
        ...
        //public ActionResult CreateRezerwacje()
        //{
        //    return View();
        //}
        //[HttpPost]
        //public ActionResult CreateRezerwacje(Rezerwacja newObj)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        _dbRezerwacja.Rezerwacja.Add(newObj);
        //        _dbRezerwacja.SaveChanges();
        //        return RedirectToAction("IndexRezerwacje", "Pracownik");
        //    }
        //    else
        //    {
        //        return View(newObj);
        //    }
        //}
        //public ActionResult EditRezerwacje(int id)
        //{
        //    var temp = (from Rezerwacja in _dbRezerwacja.Rezerwacja where Rezerwacja.R_ID == id select Rezerwacja).First();
        //    return View(temp);
        //}
        //[HttpPost]
        //public ActionResult EditRezerwacje(Rezerwacja objToEdit)
        //{
        //    var temp = (from Rezerwacja in _dbRezerwacja.Rezerwacja where Rezerwacja.R_ID == objToEdit.R_ID select Rezerwacja).First();
        //    if (!ModelState.IsValid) return View(temp);

        //    _dbRezerwacja.Entry(temp).CurrentValues.SetValues(objToEdit);
        //    _dbRezerwacja.SaveChanges();
        //    return RedirectToAction("IndexRezerwacje", "Pracownik");
        //}        //public ActionResult DetailsRezerwacje(int id)
        //{
        //    var temp = (from Rezerwacja in _dbRezerwacja.Rezerwacja where Rezerwacja.R_ID == id select Rezerwacja).First();
        //    return View(temp);
        //}
        //public ActionResult DeleteRezerwacje(int id)
        //{
        //    var temp = (from Rezerwacja in _dbRezerwacja.Rezerwacja where Rezerwacja.R_ID == id select Rezerwacja).First();
        //    return View(temp);
        //}
        ...
        //// POST: /Home/Delete/5
        //[HttpPost]
        //public ActionResult DeleteRezerwacje(Rezerwacja objToDelete)
        //{
        //    var temp = (from Rezerwacja in _dbRezerwacja.Rezerwacja where Rezerwacja.R_ID == objToDelete.R_ID select Rezerwacja).First();
        //    if (!ModelState.IsValid)
        //        return View(temp);
        //    _dbRezerwacja.Entry(temp).State = System.Data.Entity.EntityState.Deleted;
        //    _dbRezerwacja.SaveChanges();
        //    return RedirectToAction("IndexRezerwacje", "Pracownik");
        //}
...
//<table>
//    <tr>
//        <td><input type = "submit" value="Przeglądaj dane Klientów"/></td>
//        <td><input type = "submit" value="Przeglądaj rezerwacje" /></td>
//        <td><input type = "submit" value="Przeglądaj pokoje" /></td>
//    </tr>
//    <tr>
//        <td colspan = "3" >
//            < table >
//                @* @foreach(var item in @HotelWebSqlMVC.Models.KlienciEntities)
//{
//                    < tr >
...
//                             < a data - value = "@item.Id" href = "javascript:void(0)" class="btnEdit">Edit</a>
//                        </td>
//                    </tr>
//                }
//            </table>*@
